(function () {
    ...
    MainController.$inject = ["$rootScope", "$scope", "$state", "$modal", "$log","page1Service", "$timeout", "$window"];
    ...
    function MainController($rootScope, $scope, $state, $modal, $log, page1Service, $timeout, $window) {
        var vm = this;
        vm.myName = "MainController";
